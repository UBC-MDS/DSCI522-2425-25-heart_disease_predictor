...
@fig-feature_densities_by_diagnosis below visualizes the relationships between key health indicators in the heart disease dataset, grouped by diagnosis. Individuals with heart disease tend to have lower maximum heart rates, as seen in @fig-feature_densities_by_diagnosis.
