...
*NOTE 4*: If you'd rather build the environment locally, you can do so either using the already provided [`environment.yml`](environment.yml) file or with `conda-lock` with any of the 4 provided platforms in the root of this repository. 
